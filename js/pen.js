          ...
          window.onload = function() {
              dispDate(); //  这里是等页面加载完再进入onload，否则getElement会没有。
              hozplayer();
              ...
              var urls = [
                  ...
                  image,
                  loaded = 0;
              for(var i=11;i<15;i++){ //100 147
                urls.push('rotatePic/'+i+'.jpg');//rotate-360x505/pic-
              }
          ...
          function triangulateIn(event) {           //分成三角形
          ...
          function build() {
              ...
              for (var i = 0; i < indices.length; i += 3) {
                  ...
                  var dx = fragment.centroid[0] - clickPosition[0],
                      ...
                      rx = 30 * sign(dy),
                      ry = 90 * -sign(dx),
                      delay = d * 0.003 * randomRange(0.9, 1.1);    //这里是分的快慢
